...
(function () {
  ...
  var IMAGES = [
    ...
    { cat: "endorsements", src: "assets/img/endorsements/toriola-and-ojebode.jpg", tag: "Honours", caption: "Coach Laja with Quadri Aruna — Africa Table Tennis Champion and Nigeria's current number one." },
