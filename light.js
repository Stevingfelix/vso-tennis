...
(function () {
  ...
  var IMAGES = [
    ...
    { cat: "endorsements", src: "assets/img/endorsements/coach-with-cosmas-maduka.jpg", tag: "Honours", caption: "Coach Laja with Dr. Cosmas Maduka — President of the Coscharis Group, former President of the Nigeria Table Tennis Federation (NTTA) and a former member of the International Table Tennis Federation (ITTF)." },
    ...
    { cat: "endorsements", src: "assets/img/endorsements/toriola-and-ojebode.jpg", tag: "Honours", caption: "Segun Toriola — former Africa and Commonwealth Table Tennis Champion and seven-time Olympian — with Michael Oyebode, Nigeria's Olympic table tennis coach." },
    { cat: "endorsements", src: "assets/img/endorsements/toriola-and-ojebode-2.jpg", tag: "Honours", caption: "Segun Toriola — former Africa and Commonwealth Table Tennis Champion and seven-time Olympian — with Michael Oyebode, Nigeria's Olympic table tennis coach." },
    { cat: "endorsements", src: "assets/img/endorsements/osun-deputy-governor-champions.jpg", tag: "Honours", caption: "The Deputy Governor of Osun State with Kasali Lasisi (former Africa Table Tennis Champion), Bose Kafo (former Africa Women's Table Tennis Champion and five-time Olympian) and Barrister Wahab Shitu (SAN)." },
